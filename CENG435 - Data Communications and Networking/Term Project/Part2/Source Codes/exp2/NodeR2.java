...
// It is the class that contains runner main method for router node R2
public class NodeR2 {

    public static void main(String args[]) {

        Router UDPClientForNodeD = new Router(1170, "D", "d.61tp.ch-geni-net.instageni.cenic.net", 1150);
        Thread UDPClientThreadForNodeD = new Thread(UDPClientForNodeD);

        Router UDPClientForNodeS = new Router(1160, "S", "s.61tp.ch-geni-net.instageni.cenic.net", 1145);
