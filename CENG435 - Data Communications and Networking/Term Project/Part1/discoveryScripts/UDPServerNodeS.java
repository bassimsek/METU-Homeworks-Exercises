...
/* Main class which executes main Server thread for Node S.*/
public class UDPServerNodeS {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            int messageCount = 1;
        	System.out.println("Server on Node S starts to listen...");

        	/* As initiator of messaging, Node S starts its sender Clients for each of its neighbour node's servers. */
        	Client UDPClientForNodeR1 = new Client("S","R1","r1.61tp.ch-geni-net.instageni.cenic.net",1060);
            Thread UDPClientThreadForNodeR1 = new Thread(UDPClientForNodeR1);

            Client UDPClientForNodeR2 = new Client("S","R2","r2.61tp.ch-geni-net.instageni.cenic.net",1070);
            Thread UDPClientThreadForNodeR2 = new Thread(UDPClientForNodeR2);

            Client UDPClientForNodeR3 = new Client("S","R3","r3.61tp.ch-geni-net.instageni.cenic.net",1080);
...
/* Sender Client thread implementation for Node S */
